...
export default function ModalForm({ user, isOpen, onClose }: Props){
  ...
  return (
    <div className="w-[1461px] h-[581px] rounded-[30px] bg-white fixed z-100 top-0 bottom-0 left-0 right-0 absolute mx-auto my-auto p-[20px] justify-center items-center">
      ...
      <form className="text-[#4E3000] text-[32px] justify-center items-center font-semibold mt-[66px] ml-[400px]" onSubmit={handleSubmit}>
          ...
          <label htmlFor="status">Присутствие</label>
            <div
              className="w-[34px] h-[34px] mr-[468px] rounded-[4px] border-[2px] border-[#757575] items-center ml-[32.11px] text-[#555555] relative items-center justify-center flex">
            <input
              type="checkbox"
              id="status"
              checked={status}
